...
const deals = [
  { id: 1, name: "iPhone 15 Pro 256GB", store: "Shopee", category: "Electronics", originalPrice: 28990000, salePrice: 21990000, discount: 24, rating: 4.8, image: "📱",
    url: "https://shopee.vn/search?keyword=iphone+15+pro+256gb" },
  { id: 2, name: "Nike Air Max 270", store: "Lazada", category: "Fashion", originalPrice: 3200000, salePrice: 1499000, discount: 53, rating: 4.6, image: "👟",
    url: "https://www.lazada.vn/catalog/?q=nike+air+max+270" },
  { id: 3, name: "Dyson V15 Detect", store: "Amazon", category: "Home", originalPrice: 14000000, salePrice: 8990000, discount: 36, rating: 4.9, image: "🌀",
    url: "https://www.amazon.com/s?k=dyson+v15+detect" },
  { id: 4, name: "MacBook Air M3", store: "Shopee", category: "Electronics", originalPrice: 32990000, salePrice: 26990000, discount: 18, rating: 4.9, image: "💻",
    url: "https://shopee.vn/search?keyword=macbook+air+m3" },
  { id: 5, name: "Laneige Lip Mask Set", store: "Lazada", category: "Beauty", originalPrice: 850000, salePrice: 399000, discount: 53, rating: 4.7, image: "💄",
    url: "https://www.lazada.vn/catalog/?q=laneige+lip+mask" },
  ...
  { id: 7, name: "Instant Pot Duo 7-in-1", store: "Shopee", category: "Home", originalPrice: 2900000, salePrice: 1590000, discount: 45, rating: 4.7, image: "🍲",
    url: "https://shopee.vn/search?keyword=instant+pot+duo" },
  { id: 8, name: "Adidas Ultraboost 23", store: "Lazada", category: "Sports", originalPrice: 4200000, salePrice: 2100000, discount: 50, rating: 4.5, image: "🏃",
    url: "https://www.lazada.vn/catalog/?q=adidas+ultraboost+23" },
  { id: 9, name: "iPad Pro 12.9\" M2", store: "Amazon", category: "Electronics", originalPrice: 27990000, salePrice: 21990000, discount: 21, rating: 4.9, image: "📟",
    url: "https://www.amazon.com/s?k=ipad+pro+12.9+m2" },
  { id: 10, name: "SK-II Facial Treatment", store: "Shopee", category: "Beauty", originalPrice: 3200000, salePrice: 2190000, discount: 32, rating: 4.8, image: "✨",
    url: "https://shopee.vn/search?keyword=skii+facial+treatment" },
  { id: 11, name: "Philips Air Fryer XXL", store: "Lazada", category: "Home", originalPrice: 4500000, salePrice: 2790000, discount: 38, rating: 4.6, image: "🍟",
    url: "https://www.lazada.vn/catalog/?q=philips+air+fryer+xxl" },
  { id: 12, name: "Garmin Fenix 7", store: "Amazon", category: "Sports", originalPrice: 18000000, salePrice: 12990000, discount: 28, rating: 4.7, image: "⌚",
    url: "https://www.amazon.com/s?k=garmin+fenix+7" },
];
...
const storeSearch: Record<string, string> = {
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <nav className="bg-gray-900 border-b border-gray-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-6 text-sm text-gray-400">
            <a href="#hot-deals" className="hover:text-orange-400 transition">Hot Deals</a>
            <a href="#categories" className="hover:text-orange-400 transition">Categories</a>
            <a href="#trending" className="hover:text-orange-400 transition">Trending</a>
          </div>
          <a href="#subscribe" className="bg-orange-500 hover:bg-orange-400 text-white text-sm font-semibold px-4 py-2 rounded-full transition">
            🔔 Get Alerts
          </a>
        </div>
      </nav>
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-950 to-orange-950 py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <form
            className="flex max-w-xl mx-auto gap-2 mb-10"
            onSubmit={(e) => {
              e.preventDefault();
              const q = (e.currentTarget.elements.namedItem("q") as HTMLInputElement).value;
              if (q) window.open(`https://shopee.vn/search?keyword=${encodeURIComponent(q)}`, "_blank");
            }}
          >
            <input
              name="q"
            ...
            />
            <button type="submit" className="bg-orange-500 hover:bg-orange-400 px-6 py-4 rounded-xl font-bold transition">
              Search
            </button>
          </form>
      ...
      <section id="categories" className="max-w-7xl mx-auto px-4 py-14">
        ...
        <div className="grid grid-cols-4 md:grid-cols-8 gap-3">
          {categories.map((cat) => (
            <a
              key={cat.name}
              href={`https://shopee.vn/search?keyword=${encodeURIComponent(cat.name)}`}
              target="_blank"
      ...
      {/* Hot Deals */}
      <section id="hot-deals" className="max-w-7xl mx-auto px-4 pb-14">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold flex items-center gap-2">🔥 Hot Deals</h2>
          <a href="https://shopee.vn/flash_sale" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-orange-300 text-sm font-medium transition">View all →</a>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {deals.map((deal) => {
            const affiliateUrl = buildAffiliateLink(deal.store, deal.url);
            return (
              <div
                key={deal.id}
      ...
      {/* Trending */}
      <section id="trending" className="bg-gray-900 py-14">
            ...
            {deals.slice(0, 8).map((deal) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer sponsored"
                  className="flex-shrink-0 bg-gray-800 rounded-xl p-4 flex items-center gap-3 w-64 hover:bg-gray-700 transition cursor-pointer border border-gray-700 hover:border-orange-500/40"
                >
      ...
      <section className="max-w-7xl mx-auto px-4 py-14">
        ...
        <div className="grid grid-cols-3 gap-4">
          {Object.entries(storeSearch).map(([store, url]) => (
            <a
              key={store}
              href={url}
              target="_blank"
              rel="noopener noreferrer"
              className={`${storeColors[store]} hover:opacity-90 rounded-2xl p-8 text-center text-white font-black text-2xl transition hover:scale-105`}
            >
              {store}
              <div className="text-sm font-normal mt-1 opacity-80">Browse all deals →</div>
            </a>
          ))}
        </div>
      </section>
